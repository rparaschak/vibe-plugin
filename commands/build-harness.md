...
---
<!-- vibe-template: commands/build-harness v3 | generated 2026-07-16 | edits below this marker are yours -->
...
3. **Scope the audit.** Run Glob-only stack detection; combine with roster + command split + `COMMAND_PREFIX`. Authoring-time only. User confirms or corrects at the checklist gate (step 5), not here.
